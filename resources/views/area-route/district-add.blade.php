           ...
           <div class="modal-body">
            ...
            <div class="row">
                <div class="col-lg-12"> 
                            ...
                            <div class="row">
                                <form role="form" action="{{action('AreaViewController@district_save')}}" method="post">
                                <input type="hidden" name="_token" value="<?= csrf_token() ?>">
                                <input type="hidden" name="districts_code" value="<?php  echo $next_district_code; ?>">
                                <div class="col-lg-6">        
                                        <div class="form-group">
                                            <label>District Name</label>
                                            <input class="form-control" name="districts_name" placeholder="District Name">
                                        </div>
                                        <div class="form-group">
                                            <label>District Code</label>
                                            <input class="form-control" name="districts_code" disabled="disabled"  value="<?php  echo $next_district_code; ?>">
                                        </div> 
                                        <div class="form-group">
