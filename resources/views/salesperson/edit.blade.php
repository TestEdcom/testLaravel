...
@section('content')
      <div id="page-wrapper">
            ...
            <div class="container-fluid">     
                 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Sales Persons</h1> 
                </div>
...
<p style="color:red" ><?php echo Session::get('message'); ?></p>      
           ...
           <div class="modal-body">
            ...
            <div class="row">
                <div class="col-lg-12">                           
                            <div class="row">                                
                                <form role="form" action="{{action('SalesPersonController@update')}}" method="post">
                                ...
                                <div class="col-lg-12">        
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Sales Person Name" class="form-control" name="name" value="<?php echo $row->name; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Sales Person Code</label>
                                            <input value="<?php echo $row->salesperson_code; ?>" disabled="disabled" class="form-control" name="salesperson_code" value="<?php echo $row->salesperson_code; ?>">
                                        </div> 
                                        <div class="form-group">
